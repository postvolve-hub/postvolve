            ...
            <div className="grid grid-cols-2 gap-4">
              <Link href="/dashboard/generate">
                <div className="p-4 border border-gray-200 rounded-xl hover:border-[#6D28D9] hover:bg-[#6D28D9]/5 transition-all duration-300 cursor-pointer group">
                  ...
                  <h4 className="font-medium text-gray-900 group-hover:text-[#6D28D9]">Generate Content</h4>
                  <p className="text-sm text-gray-500 mt-1">Create new AI-powered posts</p>
                </div>
              </Link>
              <Link href="/dashboard/scheduler">
                <div className="p-4 border border-gray-200 rounded-xl hover:border-[#6D28D9] hover:bg-[#6D28D9]/5 transition-all duration-300 cursor-pointer group">
