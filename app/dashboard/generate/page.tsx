    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">News Card Generation</h2>
            <p className="text-gray-500 mt-1">Review and customize AI-generated news cards for your audience.</p>
          </div>
        ...
        {filteredContent.length === 0 && (
          <div className="text-center py-16 bg-white rounded-xl">
            ...
            <p className="text-gray-500 mb-6">Generate new news cards to see posts here.</p>
